...
export const curriculum: Week[] = [
  ...
  },
  {
    ...
    days: [
      ...
      { day: 2, title: 'Ignition & TurboFan', topics: ['Speculation', 'Type feedback', 'Mono/poly/megamorphic'] },
      { day: 3, title: 'Hidden Classes', topics: ['Hidden classes', 'Transition trees', 'Inline caching'] },
      { day: 4, title: 'Deoptimization', topics: ['Bailouts', 'Causes', 'Thrashing'] },
      { day: 5, title: 'Stack vs Heap', topics: ['Primitives', 'Objects & references', 'Memory layout'] },
